...
<html>
  <head>
   ...
   <script type="text/javascript" src="<c:url value='/zw/js/farmer/regist.js'/>"></script>
  </head>
  
  <body>
    <div id="divMain">
       <div id="divTitle">
         <span id="spanTitle">新农户注册</span>
       </div>
       <div id="divBody">
         <form method="post" action="<c:url value='/farmer/regist.action'/>" id="registForm">
          ...
          <table id="tableForm">
            ...
            <tr>
             ...
             <tr>
              ...
              <td class="tdInput">
                  <input type="text" name="phone" class="inputClass" value="${form.phone }"></input>
              </td>
              <td class="tdError">
                  <label class="errorClass" id="emailError">${errors.phone }</label>
              </td>
            </tr>
            <tr>
