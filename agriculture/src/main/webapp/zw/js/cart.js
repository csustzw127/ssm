$(function() {
	...
	$("#selectAll").click(function() {
		var flag = $("#selectAll")[0]["checked"];//获取全选的状态
...
function setAll(flag) {
    var ele = 	$(":checkbox[name=checkboxBtn]");
...
function showTotal() {
	...
	1. 获取所有被勾选的复选框，遍历之
	*/
    var allCheckBox = $("input[type='checkbox'][name='checkboxBtn']");
	for (var i = 0; i < allCheckBox.length; i++) {
		/*
	 2. 通过复选框找到小计
	 */
		if (allCheckBox[i]["checked"] == true) {
			var subtotal = Number($("#" + allCheckBox[i].value + "Subtotal").text());
			total += subtotal;
		}
	}
	/*
