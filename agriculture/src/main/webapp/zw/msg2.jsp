...
a:hover {color:#FF6600; text-decoration: underline;}
  ...
  <c:choose>
  	<c:when test="${code eq 'success' }">
  		<c:set var="img" value="/zw/image/duihao.jpg"/>
  		<c:set var="title" value="成功"/>
  	</c:when>
  	<c:when test="${code eq 'error' }">
  		<c:set var="img" value="/zw/image/cuohao.png"/>
...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<br/>
		<br/>
		<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/zw/farmer/login.jsp'/>">登录</a></span>
	  </div>
	</div>
</div>
